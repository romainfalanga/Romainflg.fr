  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="glass-effect rounded-2xl shadow-lg border border-white/20 p-6 sm:p-8 mb-6 sm:mb-8 animate-fade-in">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
            <div className="flex-1 lg:pr-8 text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Chess 13</h1>
      ...
      <ApplicationModal
        ...
        projectName="Chess 13"
        position={selectedPosition}
        tiktokPlaceholder="@chess13_pseudo"
      />
    </div>
  );
}