  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-6 lg:space-y-0">
            <div className="flex-1 lg:pr-8">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-sm font-semibold text-primary-600 bg-primary-50 px-3 py-1 rounded-full">Projet 3</span>
              </div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">Chess 100</h1>
      ...
      <ApplicationModal
        ...
        projectName="Chess 100"
        position={selectedPosition}
        tiktokPlaceholder="@chess100_pseudo"
      />
    </div>
  );
}